...
export default class AddContacts extends React.Component {
  ...
  render() {
    ...
    const SelectIndustryplaceholder = {
    ...
    return (
      ...
      <View style={{flexDirection:'row',marginTop:10}}>
            ...
            <View style={{}}>
            <RNPickerSelect
              placeholder={SelectIndustryplaceholder}
            style={{ ...pickerSelectStyles,
      ...
      <View style={{marginTop:10}}>
         <View style={{flexDirection:'row'}}>
            <Text style={{ fontSize: 16, color: '#000',  }}>Note</Text>
          </View>
          <View style={styles.textAreaContainer} >
    <TextInput
    ...
    />
      ...
      <View style={{marginTop:10}}>
        <View style={{flexDirection:'row',}}>
            <Text style={{ fontSize: 16, color: '#000',  }}>Attachements</Text>
           <Image source={require('../Assets/attached.png')} style={{width:30,height:30,resizeMode:'contain',paddingLeft:20}}></Image>
          </View>        
      </View>
      <View style={{marginTop:10}}>
         <View style={{flexDirection:'row'}}>
